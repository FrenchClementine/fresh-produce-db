...
import { useMySuppliers } from '@/hooks/use-my-data'
...
export default function MySuppliersPage() {
  ...
  const { suppliers, isLoading, error } = useMySuppliers()
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold tracking-tight">My Suppliers</h1>
        </div>
        <div className="text-center py-12">Loading your suppliers...</div>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12 text-red-500">
          Error loading your suppliers: {(error as Error).message}
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12 text-muted-foreground">
          You must be logged in as a staff member to view your suppliers.
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Suppliers assigned to you ({currentStaff.name})
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Your Supplier Directory</CardTitle>
        ...
        <CardContent>
          {filteredSuppliers.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              {suppliers?.length === 0
                ? 'No suppliers assigned to you yet. Contact your admin to assign suppliers or add new ones.'
              ...
              <TableBody>
                {filteredSuppliers.map((supplier: any) => (
                  <TableRow
                    ...
                    onClick={() => router.push(`/my/suppliers/${supplier.id}`)}
                  >
                    <TableCell>
