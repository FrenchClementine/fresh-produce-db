...
import { useMyCustomers } from '@/hooks/use-my-data'
...
export default function MyCustomersPage() {
  ...
  const { customers, isLoading, error } = useMyCustomers()
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">Loading your customers...</div>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12 text-red-500">
          Error loading your customers: {(error as Error).message}
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12 text-muted-foreground">
          You must be logged in as a staff member to view your customers.
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Customers assigned to you ({currentStaff.name})
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Your Customer Directory</CardTitle>
        ...
        <CardContent>
          {filteredCustomers.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              {customers?.length === 0
                ? 'No customers assigned to you yet. Contact your admin to assign customers or add new ones.'
              ...
              <TableBody>
                {filteredCustomers.map((customer: any) => (
                  <TableRow
                    ...
                    onClick={() => router.push(`/my/customers/${customer.id}`)}
                  >
                    <TableCell>
